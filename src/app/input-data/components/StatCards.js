...
export default function StatCards({ stats, historyData }) {
  ...
  const barData = useMemo(() => {
    ...
    historyData.forEach(item => { 
      if(counts[item.jenis_bantuan] !== undefined) counts[item.jenis_bantuan]++ 
    })
  ...
  return (
    <div className="space-y-8 animate-fadeIn">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
        ...
        <StatCard title="Disetujui" count={stats.approved} colorClass="bg-emerald-600" icon={<svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>} />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
         <div className="bg-white border border-slate-200 rounded-xl p-5 flex flex-col">
           <h3 className="text-slate-500 text-[11px] font-bold uppercase tracking-wider mb-4 border-b border-slate-100 pb-2">Status Validasi Pengajuan</h3>
         ...
         <div className="md:col-span-2 bg-white border border-slate-200 rounded-xl p-5 flex flex-col">
           <h3 className="text-slate-500 text-[11px] font-bold uppercase tracking-wider mb-4 border-b border-slate-100 pb-2">Distribusi Program Kerja</h3>
